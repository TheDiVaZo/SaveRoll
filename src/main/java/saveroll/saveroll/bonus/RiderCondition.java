...
public class RiderCondition extends Condition {
    ...
    protected static class RiderBonus {
        ...
        private static ArrayList<EntityType> generateEntities(@NotNull List<String> entitiesNames) throws NotExistObjectFromStringException {
            ...
            for (String entityName : entitiesNames) {
                ...
                EntityType entity = getObjectFromString(entityName, EntityType.class);
                generatedEntities.add(entity);
            }
            return generatedEntities;
        }
        private static ArrayList<Material> generateArmors(@NotNull List<String> armorsNames) throws NotExistObjectFromStringException {
            ...
            for (String armorName : armorsNames) {
                ...
                Material armor = getObjectFromString(armorName, Material.class);
                generatedArmors.add(armor);
            }
            return generatedArmors;
        }

        public static RiderBonus generateAnimalsBonus(@NotNull List<String> entitiesNames, @NotNull List<String> armorsNames, int additionalRoll) throws NotExistObjectFromStringException {
        ...
        public int getBonusFromPlayer(Player player) {
            ...
            for (EntityType entity : entities) {
                ...
                if(armors.isEmpty() && livingEntity.getType().equals(entity)) return additionalRoll;
            }
            return 0;
        }
    }
    ...
    @NotNull public static Condition generateBonus(@NotNull ConfigRiderParam...configRiderParams) throws NotExistObjectFromStringException {
    ...
    @NotNull public static Condition generateBonus(@NotNull List<ConfigRiderParam> configRiderParams) throws NotExistObjectFromStringException {
        ArrayList<RiderBonus> riderBonuses = new ArrayList<>();
        RiderCondition bonus = new RiderCondition(riderBonuses);
        for (ConfigRiderParam riderParam : configRiderParams) {
            RiderBonus riderBonus = RiderBonus.generateAnimalsBonus(riderParam.getAnimals(), riderParam.getArmors(), riderParam.getAdditionalRoll());
